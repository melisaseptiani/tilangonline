...
<body>
  <section class="content">
      <div class="container-fluid">
        ...
        <div class="row">
    <a href="<?php echo base_url(); ?>Fom" class="btn btn-primary">Tambah Data</a>
    ...
    foreach ($pelanggar as $u) {
     ...
     <tr>
      ...
      <td><?php echo $u->pasal
       ...
       <td>
        <a target="_blank" class="btn btn-primary" href="<?=base_url()?>Fom/surat_tilang/<?=$u->idpelanggaran?>">Surat Tilang</a><br>
